      ...
      <section className="py-12 sm:py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 sm:p-8 mb-6 sm:mb-8 shadow-lg ">
            ...
            <p className="text-[rgb(39,89,83)] text-700 text-base sm:text-lg mb-4">
            ...
            <p className="text-[rgb(39,89,83)] text-700 text-base sm:text-lg">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 sm:p-8 shadow-lg">
            ...
            <ul className="space-y-2 sm:space-y-3 text-[rgb(39,89,83)] text-base sm:text-lg">
